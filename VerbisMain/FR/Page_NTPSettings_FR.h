#ifndef FR_PAGE_NTPSETTINGS_FR_H
#define FR_PAGE_NTPSETTINGS_FR_H

const char PAGE_NTPConfiguration[] PROGMEM = R"=====(
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Param&egrave;tres NTP</strong>
<hr>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" >
<tr><td align="right">Serveur NTP:</td><td><input type="text" id="ntpserver" name="ntpserver" maxlength="172" value=""></td></tr>
<tr><td align="right">R&eacute;actualiser:</td><td><input type="text" id="update" name="update" size="3"maxlength="6" value=""> minutes (0=d&eacute;sactiver)</td></tr>
<tr><td>Fuseau horaire</td><td>
...
<tr><td align="right">Heure d'&eacute;t&eacute;:</td><td><input type="checkbox" id="dst" name="dst"></td></tr>
<tr><td align="right">Format 24h:</td><td><input type="checkbox" id="fmt24" name="fmt24"></td></tr>
<tr><td colspan="2" align="center"><input type="submit" style="width:150px" class="btn btn--m btn--blue" value="Sauvgarder"></td></tr>
</table>
</form>
<script>
...
#endif /* FR_PAGE_NTPSETTINGS_FR_H */
