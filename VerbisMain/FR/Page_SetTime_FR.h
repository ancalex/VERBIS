#ifndef FR_PAGE_SETTIME_FR_H
#define FR_PAGE_SETTIME_FR_H

const char PAGE_SetTime[] PROGMEM = R"=====(
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>R&eacute;glage manuel de l'heure</strong>
<hr>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" >
<tr><td align="right">Heure:</td><td><input type="text" id="set_hour" name="set_hour" size="3" maxlength="2" value=""></td></tr>
<tr><td align="right">Minute:</td><td><input type="text" id="set_minute" name="set_minute" size="3" maxlength="2" value=""></td></tr>
<tr><td align="right">Seconde:</td><td><input type="text" id="set_second" name="set_second" size="3" maxlength="2" value=""></td></tr>
