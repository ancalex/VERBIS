#ifndef FR_PAGENETWORKCONFIGURATION_FR_H
#define FR_PAGENETWORKCONFIGURATION_FR_H
...
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Configuration du r&eacute;seau</strong>
<hr>
...
<tr><td align="right">Le mot de passe:</td><td><input type="text" id="password" name="password" value=""></td></tr>
...
<tr><td colspan="2" align="center"><input type="submit" style="width:150px" class="btn btn--m btn--blue" value="Sauvegarder"></td></tr>
</table>
</form>
<hr>
<strong>&Eacute;tat de la connexion:</strong><div id="connectionstate">N/A</div>
<hr>
<strong>R&eacute;seaux:</strong><br>
<table border="0"  cellspacing="3" style="width:310px" >
<tr><td><div id="networks">Balayage...</div></td></tr>
<tr><td align="center"><a href="javascript:GetState()" style="width:150px" class="btn btn--m btn--blue">Rafra&icirc;chir</a></td></tr>
</table>
...
Veuillez patienter....Configuration et red&eacute;marrage.
)=====";
...
void send_connection_state_values_html()
{
	...
	if (WiFi.status() == 0) state = "Idle";
	else if (WiFi.status() == 1) state = "AUCUN SSID DISPONIBLE";
	else if (WiFi.status() == 2) state = "BALAYAGE TERMIN&Eacute;E";
	else if (WiFi.status() == 3) state = "LI&Eacute;";
	else if (WiFi.status() == 4) state = "ECHEC DE CONNEXION";
	else if (WiFi.status() == 5) state = "CONNEXION PERDUE";
	else if (WiFi.status() == 6) state = "D&Eacute;BRANCH&Eacute;";
	 ...
	 if (n == 0)
	 {
		 Networks = "<font color='#FF0000'>Aucun réseau trouvé !</font>";
	 }
	else
    {


		Networks = "Trouv&eacute; " +String(n) + " R&eacute;seaux<br>";
		Networks += "<table border='0' cellspacing='0' cellpadding='3'>";
		Networks += "<tr bgcolor='#DDDDDD' ><td><strong>Nom</strong></td><td><strong>Qualit&eacute;</strong></td><td><strong>Enc</strong></td><tr>";
		for (int i = 0; i < n; ++i)
		{
			int quality=0;
			if(WiFi.RSSI(i) <= -100)
...
#endif /* FR_PAGENETWORKCONFIGURATION_FR_H */
