#ifndef FR_PAGE_INFORMATION_FR_H
#define FR_PAGE_INFORMATION_FR_H
...
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Informations sur le r&eacute;seau</strong>
<hr>
...
#endif /* FR_PAGE_INFORMATION_FR_H */
